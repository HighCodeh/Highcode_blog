    ...
    <footer className="py-16 relative">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center gap-8">
          <h3 className="text-2xl font-bold text-gradient">Conecte-se conosco</h3>
          <div className="flex flex-wrap justify-center gap-6">
            <Link
              href="https://github.com/HighCodeh"
              target="_blank"
              className="glass-effect p-4 rounded-xl hover:scale-110 transition-transform duration-300"
            >
            ...
            <Link
              href="https://t.me/+LLVmIwy12Q9lODkx"
              target="_blank"
              className="glass-effect p-4 rounded-xl hover:scale-110 transition-transform duration-300"
            >
              <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="currentColor">
            ...
            <Link
              href="https://discord.gg/rj7B8e4B2f"
              target="_blank"
              className="glass-effect p-4 rounded-xl hover:scale-110 transition-transform duration-300"
            >
              <svg viewBox="0 0 24 24" className="w-6 h-6 text-white" fill="currentColor">
